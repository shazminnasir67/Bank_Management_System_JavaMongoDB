...
public class BlankPlotChart1 extends JComponent {

    public BlankPlotChatRender1 getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChatRender(BlankPlotChatRender1 blankPlotChatRender) {
    ...
    private BlankPlotChatRender1 blankPlotChatRender;
