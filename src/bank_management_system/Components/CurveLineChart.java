...
public class CurveLineChart extends JComponent {
    ...
    private final List<ModelLegend1> legends = new ArrayList<>();
    ...
    public void addLegend(String name, Color color1, Color color2) {
        ModelLegend1 data = new ModelLegend1(name, color1, color2);
        legends.add(data);
        LegendItem1 legend = new LegendItem1(data, legends.size() - 1);
    ...
    private void clearLegendSelected(LegendItem1 item) {
        item.setSelected(true);
        for (Component com : panelLegend.getComponents()) {
            if (com instanceof LegendItem1) {
                LegendItem1 l = (LegendItem1) com;
                if (l != item) {
                    l.setSelected(false);
                }
            }
